...
class NoteSymbolSelectSheet extends StatelessWidget {
  const NoteSymbolSelectSheet({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final NoteSymbolSelectController controller =
        NoteSymbolSelectController.find;
